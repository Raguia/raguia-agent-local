            ...
            if sys.platform == "darwin":
                a = _run_osascript(
                    (
                        ...
                        f"{'Collez le nouveau jeton JWT agent :'!r} "
                        f"with title {'Raguia — Mettre a jour le jeton'!r} "
        ...
        if r.returncode != 0:
            ...
            if sys.platform == "darwin":
                ...
                a = _run_osascript(
                    (
                        "text returned of (display dialog "
                        f"{prompt!r} with title {title!r} default answer \"\"{hidden} "
                        "buttons {\"Annuler\", \"Valider\"} default button \"Valider\" "
                        "cancel button \"Annuler\")"
                    )
                )
        ...
        if sys.platform == "darwin":
            a = _run_osascript(
                (
                    ...
                    f"{body!r} with title {'Raguia — Mise a jour depuis Git'!r} "
    ...
    try:
        ...
        if sys.platform == "darwin":
            a = _run_osascript(
                (
                    "button returned of (display dialog "
                    f"{body!r} with title {'Raguia — Mise a jour'!r} "
                    "buttons {\"Annuler\", \"Continuer\"} default button \"Continuer\" "
                    "cancel button \"Annuler\")"
                )
            )
    ...
    try:
        ...
        if sys.platform == "darwin":
            a = _run_osascript(
                (
                    "button returned of (display dialog "
                    f"{body!r} with title {'Raguia — Desinstallation'!r} with icon caution "
